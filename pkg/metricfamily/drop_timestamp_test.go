...
func TestDropTimestamp(t *testing.T) {
	...
	metric := func(timestamp *int64) *clientmodel.Metric {
		return &clientmodel.Metric{TimestampMs: timestamp}
	}
	timestamp := func(timestamp int64) *int64 {
		return &timestamp
	}
